package com.darin.nettylearning.tcpserver;
...
public class NettyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    */
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        System.out.println("Server is reading thread: " + Thread.currentThread().getName());
        System.out.println("Server ctx = " + ctx);
        System.out.println("Find out the relationship between channel and pipeline");
